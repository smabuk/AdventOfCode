...
{
	private const string AttributeName = "AdventOfCode.SourceGenerators.GenerateParsableAttribute";
	...
	private const string AttributeSource = """
		...
		internal sealed class GenerateParsableAttribute : global::System.Attribute
		{
		}
		""";
	...
	public void Initialize(IncrementalGeneratorInitializationContext context)
	{
		...
		context.RegisterPostInitializationOutput(ctx => ctx.AddSource(
			"GenerateParsableAttribute.g.cs",
