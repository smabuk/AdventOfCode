...
public static class GlobalConstants
{
	...
	public const string PHASE_VISUALISER = "Visualiser";
	...
	public const string EXCEPTION_PART1 = $"{EXCEPTION}{PHASE_PART1}";
	public const string EXCEPTION_PART2 = $"{EXCEPTION}{PHASE_PART2}";

	public const string EXCEPTION_MESSAGE = $"** {EXCEPTION} **";
	public const string NO_INPUT_MESSAGE = "* NO INPUT DATA *";
